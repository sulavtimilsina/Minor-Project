...
import 'package:helloflutter/models/chat_model/chat_user.dart';

class ConstultaionScreen extends StatefulWidget{
  @override
  _ChatPageState createState() => _ChatPageState();
}

class _ChatPageState extends State<ConstultaionScreen> {
